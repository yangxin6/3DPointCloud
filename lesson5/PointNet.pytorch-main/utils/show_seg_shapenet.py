...
parser.add_argument('--model', type=str, required=True, help='model path')#模型路径
parser.add_argument('--idx', type=int, default=0, help='model index') #选取model，例如0/704
parser.add_argument('--dataset', type=str, required=True, help='dataset path')#数据集的路径
...
print("model %d/%d" % (idx, len(test_dataset))) #选取model，例如0/704
